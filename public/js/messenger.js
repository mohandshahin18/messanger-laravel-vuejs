    ...
    <div class="message ${c}">
        ...
        <div class="message-inner">
            ...
            <div class="message-footer">
                <span class="extra-small text-muted">${ moment(msg.created_at).format('LT')}</span>
            </div>
        </div>
    </div>`);
};
            ...
            <div class="row gx-5">
                <div class="col-auto">
                    <div class="avatar avatar-online">
                        <img src="${chat.participants[0].avatar_url}" class="avatar-img">
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <span class="text-muted extra-small ms-2"> ${ moment(chat.last_message.created_at).format('LT')}</span>
                    </div>
